...
/**
 * @brief Yeebo-specific initialization sequence for 800x1280 display
 * 
 * This initialization sequence is optimized for Yeebo YB-TG8001280S01A displays
 * with proper timing parameters for ESP32-P4 2-lane MIPI DSI.
 */
extern const ili9881c_lcd_init_cmd_t vendor_specific_init_yeebo[];
extern const size_t vendor_specific_init_yeebo_size;
